        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            Table ini berisikan tentang data karyawan yang bekerja di MSI.co
                            <a target="_blank" href="../datakaryawan/index.php">Klik disini</a>
                            untuk mengubah dan melihat detail lebih
                            lanjut
                        </div>
                    </div>
                    <!-- table karyawan-->
